...
app.get("/hashcheck", (err, res) => {
    bcrypt.compare("12345", "$2b$10$Snvxvu2kUvXBW.s3zjFzduYxIrYcivrM.cavVZRQy1CIOdBCSpC96"
...
app.get("/jwtauth", (req, res) => {
    const token = jwt.sign({ email: "walterwhite@email.com" }, password);
